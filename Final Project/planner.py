...
#      layers.append(torch.nn.Conv2d(32,32,5,2,2))
#      layers.append(torch.nn.ReLU())
#      layers.append(torch.nn.Conv2d(32,1,1,1))
...
#      layers.append(torch.nn.Conv2d(64,128,2,1,1))
#      layers.append(torch.nn.Conv2d(128,1,1,1))




#      layers.append(torch.nn.Conv2d(3,16,4,1,1))
#      layers.append(torch.nn.ReLU())
#      layers.append(torch.nn.MaxPool2d(2))
#      layers.append(torch.nn.Conv2d(16,32,3,2,1))
#      layers.append(torch.nn.ReLU())
#      layers.append(torch.nn.MaxPool2d(2))
#      layers.append(torch.nn.BatchNorm2d(32))
#      layers.append(torch.nn.Conv2d(32,64,3,2,1))
#      layers.append(torch.nn.ReLU())
#      layers.append(torch.nn.MaxPool2d(2))
#      layers.append(torch.nn.BatchNorm2d(64))
#      layers.append(torch.nn.Conv2d(64,128,2,1,1))
#      layers.append(torch.nn.Conv2d(128,1,1,1,1))
#
...
#      layers.append(torch.nn.Conv2d(3,16,5,1,1))
#      layers.append(torch.nn.ReLU())
#      layers.append(torch.nn.MaxPool2d(2))
#      layers.append(torch.nn.Conv2d(16,32,4,2,1))
#      layers.append(torch.nn.ReLU())
#      layers.append(torch.nn.MaxPool2d(2))
#      layers.append(torch.nn.BatchNorm2d(32))
#      layers.append(torch.nn.Conv2d(32,64,3,2,1))
